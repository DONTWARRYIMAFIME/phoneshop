        ...
        <c:if test="${not empty order.orderItems}">
            ...
            <form:form method="post" modelAttribute="OrderDto" cssClass="pl-3">
                ...
                <div class="form-group">
                    <div class="row">
                        <label for="firstName" class="required col-2 pl-0">First name</label>
                ...
                <div class="form-group">
                    <div class="row">
                        <label for="lastName" class="required col-2 pl-0">Last name</label>
                ...
                <div class="form-group">
                    <div class="row">
                        <label for="address" class="required col-2 pl-0">Address</label>
                ...
                <div class="form-group">
                    <div class="row">
                        <label for="phone" class="required col-2 pl-0">Phone</label>
