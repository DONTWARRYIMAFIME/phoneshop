...
public class JdbcOrderItemDao implements OrderItemDao {
    private static final String INSERT_ORDER_ITEMS = "INSERT INTO orderItems (phoneId, orderId, quantity) " +
    ...
    public void insertOrderItems(Order order) {
        ...
        namedParameterJdbcTemplate.batchUpdate(INSERT_ORDER_ITEMS, sqlParameterSources);
    }
}